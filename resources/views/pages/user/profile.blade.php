		...
		background-image: url('assets/media/images/2600x1200/bg-5-dark.png');
           ...
           <div class="kt-card flex-col gap-5 justify-between bg-[center_top_1.3rem] bg-no-repeat pt-5 lg:pt-10 px-5 start-now-bg bg-[length:700px]">
            <div class="text-center">
             ...
             <a class="kt-btn kt-btn-mono" href="html/demo10/network/user-table/visitors.html">
              Start Now
             </a>
            </div>
            <div class="text-center">
                 ...
                 <div class="flex items-center grow gap-2.5">
                  <img alt="" class="rounded-full size-9 shrink-0" src="assets/media/avatars/300-3.png">
                   <div class="flex flex-col gap-1">
                    <a class="text-sm font-medium text-mono hover:text-primary mb-px" href="html/demo10/public-profile/profiles/creator.html">
                     Tyler Hero
                    </a>
...
MB 26 Sep 2024 3:20 PM
            ...
            <div class="kt-card-footer justify-center">
             <a class="kt-link kt-link-underlined kt-link-dashed" href="html/demo10/account/integrations.html">
              All Files
             </a>
            </div>
           </div>
