...
@section('content')
    <div class="kt-container-fixed">
        <div class="flex grow gap-5 lg:gap-7.5">
            <div class="hidden w-[230px] shrink-0 lg:block">
                <div class="w-[230px]" data-kt-sticky="true" data-kt-sticky-animation="true"
                    ...
                    data-kt-sticky-offset="200" data-kt-sticky-target="#scrollable_content" data-kt-sticky-initialized="true">
                    <div class="relative flex grow flex-col before:absolute before:bottom-0 before:left-[11px] before:top-0 before:border-l before:border-border"
                        data-kt-scrollspy="true" data-kt-scrollspy-offset="110px"
                        data-kt-scrollspy-target="#scrollable_content" data-kt-scrollspy-initialized="true">
                        <a class="hover:text-primary kt-scrollspy-active:bg-secondary-active kt-scrollspy-active:text-primary kt-scrollspy-active:font-medium active flex items-center gap-1.5 rounded-lg border border-transparent py-2.5 pl-2.5 pr-2.5 text-sm text-foreground hover:rounded-lg hover:font-medium"
                            data-kt-scrollspy-anchor="true" href="#basic_settings">
                            <span
                                class="kt-scrollspy-active:before:bg-primary relative flex w-1.5 before:absolute before:top-0 before:size-1.5 before:-translate-x-2/4 before:-translate-y-2/4 before:rounded-full">
                            </span>
                            Basic Settings
                        </a>
                        <div class="flex flex-col">
                            <div class="py-2.5 pl-6 pr-2.5 text-sm font-semibold text-mono">
                                Authentication
                            </div>
                            <div class="flex flex-col">
                                <a class="hover:text-primary kt-scrollspy-active:bg-secondary-active kt-scrollspy-active:text-primary kt-scrollspy-active:font-medium flex items-center gap-3.5 rounded-lg border border-transparent py-2.5 pl-2.5 pr-2.5 text-sm text-foreground hover:rounded-lg hover:font-medium"
                        ...
                        <a class="hover:text-primary kt-scrollspy-active:bg-secondary-active kt-scrollspy-active:text-primary kt-scrollspy-active:font-medium flex items-center gap-1.5 rounded-lg border border-transparent py-2.5 pl-2.5 pr-2.5 text-sm text-foreground hover:rounded-lg hover:font-medium"
            ...
            <div class="flex grow flex-col items-stretch gap-5 lg:gap-7.5">
                {{-- Basic Info --}}

                @include('pages.user.partials.basic_info')
                    ...
                    <div class="kt-card-content grid gap-5 pt-7.5">
                        <div class="w-full">
                            <div class="flex flex-wrap items-baseline gap-2.5 lg:flex-nowrap">
                                ...
                                <div class="tems-start flex w-full grow flex-col gap-7.5">
                ...
                <div class="kt-card">
                    ...
                    <div class="kt-card-content">
                        <div class="mb-7 grid gap-5">
                            <div
                                class="flex flex-wrap items-center justify-between gap-2 rounded-xl border border-border px-3.5 py-2.5">
                                <div class="flex flex-wrap items-center gap-3.5">
                                    <img alt="" class="size-6 shrink-0"
                                        src="assets/media/brand-logos/google.svg">
                                    <div class="flex flex-col gap-0.5">
                                        <a class="hover:text-primary text-sm font-medium text-mono" href="#">
                                            Google
                                        </a>
                                        <a class="hover:text-primary text-sm text-secondary-foreground" href="#">
                        ...
                        <div class="mb-7.5 flex flex-wrap items-center gap-2.5">
                            <a class="kt-btn kt-btn-outline" href="#">
                                <img alt="" class="size-5 dark:hidden"
                ...
                <div class="kt-card">
                        ...
                        <div class="kt-card-content flex flex-col gap-7.5">
                            <div class="grid gap-7">
                                ...
                                <div class="grid grid-cols-1 gap-5 lg:grid-cols-3 lg:gap-7.5">
                                    <label
                                        class="align-stretch border-input has-checked:border-primary sso-active singl-sign-on-bg flex h-44 cursor-pointer rounded-xl border border-dashed bg-[length:500px] bg-center bg-no-repeat">
                                        <div class="flex grow flex-col place-content-center place-items-center rounded-xl">
                                            <div class="flex h-11 items-center">
                                                <img alt="" class="w-5"
                                                    src="assets/media/brand-logos/azure.svg">
                                            </div>
                                    ...
                                    <label
                                        ...
                                        <div class="flex grow flex-col place-content-center place-items-center rounded-xl">
                                            <div class="flex h-11 items-center">
                                                <img alt="" class="w-24"
                                                    src="assets/media/brand-logos/openid.svg">
                                            </div>
                                            <span class="text-base font-medium text-mono">
                                                OpenID Connect
                                            </span>
                            ...
                            <div class="kt-form-description text-2sm pb-5">
                    ...
                    <div class="kt-card">
                        ...
                        <div class="kt-card-content grid gap-5 lg:py-7.5">
                            <div class="flex flex-wrap items-baseline gap-2.5 lg:flex-nowrap">
                                ...
                                <div data-kt-select-wrapper="" class="kt-select-wrapper">
                                    <div data-kt-select-display="" class="kt-select-display kt-select" tabindex="0"
                                        ...
                                        <div data-kt-select-placeholder="" class="kt-select-placeholder">Select an option
                                        </div>
                                    </div>
                                    <div data-kt-select-dropdown="" class="kt-select-dropdown hidden"
                                        ...
                                        <ul role="listbox" aria-label="Select an option" class="kt-select-options"
                                            ...
                                            <li data-kt-select-option="" data-value="American English"
                                                data-text="American English" class="kt-select-option" role="option"
                                                aria-selected="true">
                                                <div class="kt-select-option-text" data-kt-text-container="true">
                                                    ...
                                                    class="text-primary kt-select-option-selected:block ms-auto hidden size-3.5">
                                                    <path d="M20 6 9 17l-5-5"></path>
                                                </svg>
                                            </li>
                                            <li data-kt-select-option="" data-value="Option 2" data-text="Option 2"
                                            ...
                                            <li data-kt-select-option="" data-value="Option 3" data-text="Option 3"
                                                class="kt-select-option" role="option" aria-selected="false">
                                                <div class="kt-select-option-text" data-kt-text-container="true">
                                                    Option 3
                                                </div><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            ...
                            <div class="flex flex-wrap items-baseline gap-2.5 lg:flex-nowrap">
                                ...
                                <div class="grow">
                                    ...
                                    <div data-kt-select-wrapper="" class="kt-select-wrapper">
                                        <div data-kt-select-display="" class="kt-select-display kt-select" tabindex="0"
                                            role="button" data-selected="0" aria-haspopup="listbox"
                                            aria-expanded="false" aria-label="Select an option">
                                            <div data-kt-select-placeholder="" class="kt-select-placeholder">Select an
                                                option
                                            </div>
                                        </div>
                                        <div data-kt-select-dropdown="" class="kt-select-dropdown hidden"
                                            ...
                                            <ul role="listbox" aria-label="Select an option" class="kt-select-options"
                                                data-kt-select-options="true">
                                                <li data-kt-select-option=""
                                                    data-value="GMT -5:00 - Eastern Time(US &amp; Canada)"
                                                    data-text="GMT -5:00 - Eastern Time(US &amp; Canada)"
                            ...
                            <div class="mb-2 flex flex-wrap items-baseline gap-2.5 lg:flex-nowrap">
                                <label class="kt-form-label max-w-56">
                                    Currency
                                </label>
                                <div class="grow">
                                    ...
                                    <div data-kt-select-wrapper="" class="kt-select-wrapper">
                                        ...
                                        <div data-kt-select-dropdown="" class="kt-select-dropdown hidden"
                                            ...
                                            <ul role="listbox" aria-label="Select an option" class="kt-select-options"
                                                data-kt-select-options="true">
                                                <li data-kt-select-option="" data-value="United States Dollar (USD)"
                                                    data-text="United States Dollar (USD)" class="kt-select-option"
                            ...
                            <div class="mb-1.5 flex flex-wrap gap-2.5">
                                <label class="kt-form-label max-w-56 items-baseline">
                                    Attributes
                                </label>
                                <div class="flex flex-col items-start gap-5">
                                    ...
                                    <div class="flex flex-col gap-2.5">
                                        <label class="kt-label">
                                            <input checked="" class="kt-checkbox" name="attributes" type="checkbox"
                                                value="2">
                    ...
                    <div class="kt-card">
                        ...
                        <div class="kt-card-content lg:py-7.5">
                            ...
                            <div class="grid grid-cols-1 gap-5 lg:grid-cols-3 lg:gap-7.5">
                                <div>
                                    <label
                                        class="border-input has-checked:border-green-500 has-checked:border-3 has-checked:[&amp;_.checked]:flex mb-0.5 flex h-[170px] items-end rounded-xl border bg-cover bg-no-repeat"
                                        ...
                                        <span class="checked hidden">
                                            <i
                                                class="ki-solid ki-check-circle mb-5 ml-5 text-xl leading-none text-green-500">
                                            </i>
                                        </span>
                                    </label>
                            ...
                            <div class="mb-8 mt-7 border-t border-border">
                            </div>
                            <div class="mb-8 flex flex-wrap items-baseline gap-2.5 lg:flex-nowrap">
                                <label class="kt-form-label max-w-48">
                                    Transparent sidebar
                                </label>
                                <div class="flex grow items-center gap-7.5">
                                    <label class="kt-label">
                                        Visible
                                        <input checked="" class="kt-switch" type="checkbox" value="1">
                                    </label>
                    ...
                    <div class="kt-card">
                        ...
                        <div class="kt-card-content lg:py-7.5">
                            <div class="mb-5 flex flex-wrap items-center gap-5 lg:mb-7">
                                <div
                                    class="flex grow flex-wrap items-center justify-between gap-2 rounded-xl border border-border px-3.5 py-2.5">
                                    <div class="flex flex-wrap items-center gap-3.5">
                                        <div class="relative size-[50px] shrink-0">
                                            <svg class="fill-muted/30 h-full w-full stroke-border" fill="none"
                            ...
                            <div class="mb-7 flex flex-col gap-3.5">
                                <span class="pb-0.5 text-base font-medium text-mono">
                            ...
                            <div class="mb-7 flex flex-col gap-3.5">
                                ...
                                <div class="flex flex-col items-start gap-4">
                                    ...
                                    <label class="kt-label">
                                        <input checked="" class="kt-radio" name="email_notification" type="radio"
                                            value="2">
                    ...
                    <div class="kt-card">
                        ...
                        <div class="kt-card-content grid gap-5 lg:py-7.5">
                            <div class="flex flex-wrap items-baseline gap-2.5 lg:flex-nowrap">
                                <label class="kt-form-label flex max-w-56 items-center gap-1">
                                    Address
                                </label>
                            ...
                            <div class="flex flex-wrap items-baseline gap-2.5 lg:flex-nowrap">
                                ...
                                <div class="grow">
                                    <select class="hidden" data-kt-select="true" name="kt-select"
                                    ...
                                    <div data-kt-select-wrapper="" class="kt-select-wrapper">
                                        ...
                                        <div data-kt-select-dropdown="" class="kt-select-dropdown hidden"
                                            ...
                                            <ul role="listbox" aria-label="Select an option" class="kt-select-options"
                                                data-kt-select-options="true">
                                                <li data-kt-select-option="" data-value="1" data-text="Spain"
                                                    class="kt-select-option" role="option" aria-selected="true">
                                                    <div class="kt-select-option-text" data-kt-text-container="true">
                                                        Spain
                                                    </div><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                ...
                                                <li data-kt-select-option="" data-value="2" data-text="Option 2"
                                                    class="kt-select-option" role="option" aria-selected="false">
                                                    <div class="kt-select-option-text" data-kt-text-container="true">
                                                        Option 2
                                                    </div><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                ...
                                                <li data-kt-select-option="" data-value="3" data-text="Option 3"
                                                    class="kt-select-option" role="option" aria-selected="false">
                                                    <div class="kt-select-option-text" data-kt-text-container="true">
                                                        Option 3
                                                    </div><svg viewBox="0 0 24 24" fill="none" stroke="currentColor"
                    ...
                    <div class="kt-card">
                        ...
                        <div class="kt-card-content grid gap-5 lg:gap-7.5 lg:py-7.5">
                            <div class="flex flex-wrap items-baseline gap-2.5 lg:flex-nowrap">
                                <label class="kt-form-label max-w-56 font-normal text-foreground">
                                    API Key
                                </label>
                            ...
                            <div
                                class="user-access-bg flex grow flex-wrap items-center justify-between gap-2 rounded-xl border border-border bg-[length:650px] bg-no-repeat p-5 [background-position:195px_-85px] sm:flex-nowrap rtl:[background-position:-195px_-85px]">
                                <div class="flex items-center gap-4">
                                    <div class="relative size-[50px] shrink-0">
                                        <svg class="stroke-primary/10 fill-primary-soft h-full w-full" fill="none"
                                            height="48" viewBox="0 0 44 48" width="44"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M16 2.4641C19.7128 0.320509 24.2872 0.320508 28 2.4641L37.6506 8.0359C41.3634 10.1795 43.6506 14.141 43.6506
                               ...
                               39.5311C3.04125 37.4768 0.849365 33.6803 0.849365 29.5718V18.4282C0.849365 14.3196 3.04125 10.5232 6.59937 8.46891L16.25 2.89711Z"
                                        ...
                                        <div
                                            class="absolute start-2/4 top-2/4 -translate-x-2/4 -translate-y-2/4 leading-none rtl:translate-x-2/4">
                                            <i class="ki-filled ki-security-user text-primary text-xl">
                                            </i>
                                        </div>
                                    </div>
                                    <div class="flex flex-col gap-1.5">
                                        <div class="flex flex-wrap items-center gap-2.5">
                                            <a class="hover:text-primary text-base font-medium text-mono" href="#">
                                                User Access
                                            </a>
                    ...
                    <div class="kt-card">
                        ...
                        <div class="kt-card-content grid gap-5 py-5 lg:gap-7.5 lg:py-7.5">
                            <div class="grid gap-5">
                                <div
                                    class="flex flex-wrap items-center justify-between gap-2 rounded-xl border border-border p-3.5">
                                    <div class="flex flex-wrap items-center gap-3.5">
                                        ...
                                        <div class="flex flex-col">
                                            <div class="flex items-center gap-1.5">
                                                ...
                                                <a class="hover:text-primary text-sm text-secondary-foreground"
                                                    href="#">
                    ...
                    <div class="kt-card">
                        ...
                        <div class="kt-card-content flex flex-col gap-3 lg:gap-7.5 lg:py-7.5">
