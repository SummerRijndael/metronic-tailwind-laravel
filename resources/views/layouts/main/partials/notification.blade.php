<div class="flex items-center gap-1.5">
    <!-- Notifications -->
    <button class="kt-btn kt-btn-ghost kt-btn-icon hover:[&_i]:text-primary size-8 hover:bg-background"
        data-kt-drawer-toggle="#notifications_drawer">
        <i class="ki-filled ki-notification-status text-lg">
        </i>
    </button>
    <button id="sidebar-toggle-btn" type="button" class="kt-btn kt-btn-icon kt-btn-ghost transition-all duration-300"
        title="Toggle Sidebar">
        <!-- Icon: Use an arrow that points left (indicating a collapse action) -->
